...
class IMAP4:
    ...
    def id(self):
        info='("name" "com.tencent.foxmail" "version" "7.2.9.79" "os" "windows" "os-version" "6.1" "vendor" "tencent limited" "contact" "foxmail@foxmail.com")'
        name = "ID"
        typ, dat = self._simple_command(name,info)
        return self._untagged_response(typ, dat, name)
    ...
    def _new_tag(self):
        ...
        # tag = b'C' + bytes(str(self.tagnum), self._encoding)
